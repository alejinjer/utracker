...
QT_MOC_LITERAL(1, 11, 12), // "sendResponse"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 4), // "data"
QT_MOC_LITERAL(4, 30, 13), // "writeToSocket"
QT_MOC_LITERAL(5, 44, 12), // "disconnected"
QT_MOC_LITERAL(6, 57, 9) // "readyRead"

    },
    "Connection\0sendResponse\0\0data\0"
    "writeToSocket\0disconnected\0readyRead"
};
...
void Connection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendResponse((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        case 1: _t->writeToSocket((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Connection::*)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Connection::sendResponse)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Connection::sendResponse(const QByteArray & _t1)
{
